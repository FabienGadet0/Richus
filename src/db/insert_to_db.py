...
def insert_csv_to_db_initial_dump(csv_file_path, table_name):
    ...
    date_columns = [
        ...
        if col in ["last_updated", "last_updated_fr", "datetime"]
    ]
    ...
    for col in date_columns:
        if col in df.columns:
            ...
            )  # Coerce any errors in conversion to NaT
    ...
    print(f"Data from {csv_file_path} inserted into {table_name} {df.shape} rows")
