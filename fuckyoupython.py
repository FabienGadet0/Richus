...
from src.transform import rune_calculations as rune_calculations_func, rune_pricing as rune_pricing_func, rune_price_brisage_together as rune_price_brisage_together_func
from src import init_local
from dagster import asset, define_asset_job,Definitions,ScheduleDefinition,AssetSelection
...
daily_schedule = ScheduleDefinition(job=daily_job, cron_schedule="@daily")

defs = Definitions(
    schedules=[daily_schedule],
    assets=selection,
    jobs = [main_job,daily_job])
